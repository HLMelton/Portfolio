...
<template>
    <div className="bg-[#560d00]">
        ...
        <div className="grid grid-cols-4 grid-flow-row gap-3 text-white">
            ...
            <div className="object-contain">
                <svg viewBox="0 0 410 404" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div className="object-contain">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" preserveAspectRatio="none" fill="white">
                    <path
            ...
            <div className="object-contain">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="97px" height="97px"
		...
		C95.021,50.468,95.021,46.719,92.71,44.408z" />
            ...
            <div className="object-contain">
                <svg width="111px" height="151px" viewBox="0 0 111 151" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink">
                    <!-- Generator: Sketch 47.1 (45422) - http://www.bohemiancoding.com/sketch -->
                    <title>logo_lockup_firebase_vertical</title>
                    <desc>Created with Sketch.</desc>
                    <defs>
                        <linearGradient x1="-3.48177083%" y1="17.0266727%" x2="100.833333%" y2="92.8868033%"
                            id="linearGradient-1">
                                                    ...
                                                    <g transform="translate(-6.346125, -0.160154)">
                                                        <g id="_Group_3" stroke-width="1" fill="none"
                                                            ...
                                                            <path
                                                                ...
                                                                id="_Path_" fill="#FFA000" fill-rule="nonzero"></path>
                                                            <g id="_Group_4" transform="translate(0.000000, 30.119310)">
                                                                <image id="Bitmap" opacity="0.12" x="0" y="0"
                                                                    width="74.4269822" height="94.6200974"
                                                                ...
                                                                <polygon id="Shape" fill="#F57C00" fill-rule="nonzero"
                                                                    points="70.8339555 45.1789654 50.901212 7.58665646 6.84386044 91.2103641">
                                                                </polygon>
                                                            </g>
                                                        </g>
                                                        <g id="_Group_5" stroke-width="1" fill="none"
                                                            fill-rule="evenodd"
                                                            transform="translate(3.421930, 23.299844)">
                                                            <image id="_Image_" opacity="0.2" x="0" y="0"
                                                                width="119.767558" height="131.27473"
                                                            ...
                                                            <g id="_Group_6" transform="translate(3.421930, 7.387755)"
                                                                fill-rule="nonzero" fill="#FFCA28">
                                                                <path
                                                        ...
                                                        <path
                                                            ...
                                                            id="_Compound_Path_" fill-opacity="0.2" fill="#FFFFFF"
                                                        ...
                                                        <path
                                                            ...
                                                            id="_Path_3" fill="#A52714" fill-rule="nonzero"
                                                            opacity="0.2"></path>
                                                    </g>
                                                </g>
                                                <polygon id="_Path_4" mask="url(#mask-3)"
                                                    points="-26.8777064 -6.69547618 137.374944 -6.69547618 137.374944 156.971719 -26.8777064 156.971719">
                                                </polygon>
                                                <path
                                                    d="M95.7984919,33.6246194 C95.5859256,32.3610745 94.6848395,31.3206592 93.4615125,30.9262876 C92.2381855,30.5319161 90.8962602,30.8492378 89.9812105,31.7492661 L72.2727216,49.5651223 L58.2428077,23.0544463 C57.6801918,21.9189555 56.5194912,21.2001264 55.2486188,21.2001264 C53.9777463,21.2001264 52.8170458,21.9189555 52.2544298,23.0544463 L44.6406351,37.5458126 L25.3922776,1.91410025 C23.852409,-0.984173003 19.489448,-0.216983024 18.9761585,3.02226355 L0.497735304,121.16952 L50.0301752,148.873603 C53.1471684,150.578603 56.9223279,150.578603 60.0393211,148.873603 L109.999502,121.16952 L95.7984919,33.6246194 Z"
                                                    id="_Path_5" fill="url(#linearGradient-1)" fill-rule="nonzero"
