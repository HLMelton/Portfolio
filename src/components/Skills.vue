...
<template>
    <div className="bg-[#560d00]">
        <div className="grid grid-cols-4 grid-flow-row gap-3">
            ...
            <!-- Looks like shit, but! there is a but! We have SVGs and they probably need their own component/subcomponent 
                files! And they are working as anticipated. I still need to try and figure out how to standardize the 
                formatting and maybe making them monochromatic but they're here and working as expected. -->
            <div>
